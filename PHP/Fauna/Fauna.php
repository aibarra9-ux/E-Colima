...
<head>
    ...
    <title data-translate="true">Fauna - ECOLIMA</title>
    ...
    <?php if ($modo_oscuro === 1): ?>
        <link rel="stylesheet" href="../../CSS/Fauna/styles_oscuro.css">
    <?php else: ?>
        <link rel="stylesheet" href="../../CSS/Fauna/styles.css">
    <?php endif; ?>
    <style>
    /* ==========================================================================
       SOLUCIÓN: HEADER FIJO AL HACER SCROLL (COMPORTAMIENTO HOME)
       ========================================================================== */
    .barra-superior {
        position: fixed;
        top: 0;
...
<body>
    ...
    <div class="barra-superior">
        ...
        <div class="botones-derecha" style="display: flex; align-items: center; gap: 15px;">
            <div class="caja-buscador">
                <input type="text" id="inputBuscador" data-categoria-id="2" placeholder="Buscar en fauna..." data-translate-placeholder="true">
    ...
    <div class="seccion-hero">
        <h1 class="titulo-hero" data-translate="true">FAUNA</h1>
        <p class="texto-hero" data-translate="true">Una categoría centrada en mostrar la diversa fauna del estado de Colima</p>

        <div class="barra-botones">
            <button class="boton-filtro" data-bg="../../assets/Fauna/subcategorias_bg/fauna_todos.jpg" data-translate="true">Todos</button>
            <button class="boton-filtro" data-subcategoria="13" data-bg="../../assets/Fauna/subcategorias_bg/fauna_mamiferos.jpg" data-translate="true">Mamiferos</button>
            <button class="boton-filtro" data-subcategoria="14" data-bg="../../assets/Fauna/subcategorias_bg/fauna_aves.jpg" data-translate="true">Aves</button>
            <button class="boton-filtro" data-subcategoria="15" data-bg="../../assets/Fauna/subcategorias_bg/fauna_reptiles.jpg" data-translate="true">Reptiles</button>
            <button class="boton-filtro" data-subcategoria="16" data-bg="../../assets/Fauna/subcategorias_bg/fauna_anfibios.jpg" data-translate="true">Anfibios</button>
            <button class="boton-filtro" data-subcategoria="17" data-bg="../../assets/Fauna/subcategorias_bg/fauna_invertebrados.jpeg" data-translate="true">Invertebrados</button>
        </div>
