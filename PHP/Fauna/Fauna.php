...
<body>
    ...
    <div class="seccion-hero">
        ...
        <p class="texto-hero">Una categoría centrada en mostrar la diversa fauna del estado de Colima</p>

        <div class="barra-botones">
    <button class="boton-filtro" data-bg="../../assets/Fauna/subcategorias_bg/fauna_todos.jpg">Todos</button>

    <button class="boton-filtro" data-subcategoria="13" data-bg="../../assets/Fauna/subcategorias_bg/fauna_mamiferos.jpg">Mamiferos</button>
    <button class="boton-filtro" data-subcategoria="14" data-bg="../../assets/Fauna/subcategorias_bg/fauna_aves.jpg">Aves</button>
    <button class="boton-filtro" data-subcategoria="15" data-bg="../../assets/Fauna/subcategorias_bg/fauna_reptiles.jpg">Reptiles</button>
    <button class="boton-filtro" data-subcategoria="16" data-bg="../../assets/Fauna/subcategorias_bg/fauna_anfibios.jpg">Anfibios</button>
    <button class="boton-filtro" data-subcategoria="17" data-bg="../../assets/Fauna/subcategorias_bg/fauna_invertebrados.jpeg">Invertebrados</button>
</div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Abre el modal previniendo el comportamiento por defecto del enlace
    ...
    // Evento para forzar recargas limpias al usar el historial de navegación
