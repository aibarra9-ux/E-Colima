...
<head>
    ...
    <title data-translate="true">ECOLIMA – Gestión de Publicaciones</title>
    <link rel="stylesheet" href="../../CSS/Perfil/dashboard.css">
    <link class="config-style" rel="stylesheet" href=""> <link href="https://fonts.googleapis.com/css2?family=Nunito:wght@400;600;700;800;900&family=Playfair+Display:ital,wght@0,700;1,600&display=swap" rel="stylesheet">
...
<main class="main">
    <div class="profile-card">
        ...
        <div class="profile-info" style="padding-top: 40px;">
            ...
            <div class="profile-role" data-translate="true">Control de Contenido</div>
        </div>
    </div>
    ...
    <div class="feed-panel">
        <div class="feed-tabs" style="display: flex; justify-content: space-between; align-items: center;">
            <div class="tab-btn active">
                ...
                <span data-translate="true">Explorar Publicaciones</span>
            </div>
            
            <div class="search-box">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>
                <input type="text" id="searchPost" placeholder="Buscar título o autor..." data-translate-placeholder="true">
            </div>
        </div>
