...
<head>
    ...
    <title data-translate="true">ECOLIMA – Gestión de Usuarios</title>
...
<main class="main">
  <div class="profile-card">
    ...
    <div class="profile-info" style="padding-top: 45px;">
      ...
      <div class="profile-role" data-translate="true">Gestión de Comunidad</div>
    </div>
  </div>
  ...
  <div class="feed-panel">
    <div class="feed-tabs" style="width: 100%; display: flex; align-items: center; justify-content: space-between;">
      <div class="tab-btn active">
        ...
        <span data-translate="true">Lista de Usuarios</span>
      </div>
      <div class="search-container">
          <input type="text" id="user-search" class="search-input" placeholder="🔍 Buscar nombre o correo..." data-translate-placeholder="true">
      </div>
    </div>
                ...
                <table class="users-table">
                    <thead>
                        <tr>
                            ...
                            <th data-translate="true">Correo Electrónico</th>
                            <th data-translate="true">Registro</th>
