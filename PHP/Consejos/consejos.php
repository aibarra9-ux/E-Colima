...
<head>
    ...
    <title data-translate="true">Consejos - ECOLIMA</title>
    ...
    <style>
    /* ==========================================================================
       SOLUCIÓN: HEADER FIJO AL HACER SCROLL (IGUAL QUE EN HOME)
       ========================================================================== */
    .barra-superior {
        position: fixed;
        top: 0;
        ...
        /* Si tu archivo CSS no tiene un background definido para la barra, 
           puedes descomentar la línea de abajo para heredar un color sólido */
        /* background: #1a3a2a; */ 
    }

    /* Margen de compensación para que la barra fija no tape el contenido del Hero */
    .seccion-hero {
        margin-top: 70px; /* Ajusta este tamaño dependiendo del grosor de tu topbar */
    }
...
<body>
    ...
    <div class="barra-superior">
        ...
        <div class="botones-derecha">
            ...
            <div class="caja-buscador">
                <input type="text" id="inputBuscador" data-categoria-id="5" placeholder="Buscar en consejos..." data-translate-placeholder="true">
    ...
    <div class="seccion-hero">
        <h1 class="titulo-hero" data-translate="true">Consejos</h1>
        <p class="texto-hero" data-translate="true">Una categoría centrada en mostrar consejos para cuidar la vida terrestre</p>

        <div class="barra-botones">
            <button class="boton-filtro" data-bg="../../assets/Consejos/subcategorias_bg/consejos_todos.jpg" data-translate="true">Todos</button>
            <button class="boton-filtro" data-subcategoria="34" data-bg="../../assets/Consejos/subcategorias_bg/consejos_acciones_individuales.jpg" data-translate="true">Acciones individuales</button>
            <button class="boton-filtro" data-subcategoria="35" data-bg="../../assets/Consejos/subcategorias_bg/consejos_acciones_escolares.jpg" data-translate="true">Acciones escolares</button>
            <button class="boton-filtro" data-subcategoria="36" data-bg="../../assets/Consejos/subcategorias_bg/consejos_acciones_comunitarias.jpg" data-translate="true">Acciones comunitarias</button>
            <button class="boton-filtro" data-subcategoria="37" data-bg="../../assets/Consejos/subcategorias_bg/consejos_acciones_consumo_responsable.jpg" data-translate="true">Consumo responsable</button>
        </div>
