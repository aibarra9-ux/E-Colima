...
// 2. Base de la consulta SQL (🌟 MODIFICADO: Añadido p.tipo_media a la selección)
...
// 5. Procesamos y formateamos los datos incluyendo la metadata multimedia
while($row = $resultado->fetch_assoc()) {
    // Mapeamos la ruta completa o un fallback en caso de no haber nada subido
    ...
    $publicaciones[] = [
        ...
        'imagen' => $rutaMedia, // Pasamos la ruta ya formateada al JS de forma transparente
        'tipo_media' => !empty($row['tipo_media']) ? $row['tipo_media'] : 'imagen', // 🌟 NUEVO: Mapeo clave para el JS
        'autor' => $row['autor'],
